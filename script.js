...
const TRANSLATIONS = {
  en: {
    ...
    resourcesAria: 'Open AI PM Lab free resources in a new tab', youtubeAria: 'Open AI PM Lab on YouTube in a new tab', callAria: 'Book a discovery call in a new tab', frameworkAria: 'Open the PropertyDEX framework in a new tab', propertydexAria: 'Visit the PropertyDEX website in a new tab'
  },
  it: {
    ...
    resourcesAria: 'Apri le risorse gratuite di AI PM Lab in una nuova scheda', youtubeAria: 'Apri AI PM Lab su YouTube in una nuova scheda', callAria: 'Prenota una discovery call in una nuova scheda', frameworkAria: 'Apri il framework PropertyDEX in una nuova scheda', propertydexAria: 'Visita il sito PropertyDEX in una nuova scheda'
  }
};
